...
🌍 Desarrollador Junior | 💻 Apasionado por la Programación | 🚀 Aprendiz Constante

---

## 🌟 Sobre Mí

Soy un desarrollador junior de España 🇪🇸, recién graduado en **Sistemas Microinformáticos y Redes (SMX)** y **Desarrollo de Aplicaciones Multiplataforma (DAM)**. Mi enfoque principal es la programación, y disfruto creando aplicaciones eficientes, funcionales y visualmente atractivas.

Estoy comprometido con el aprendizaje continuo y mi meta es fortalecer mis habilidades tanto en el desarrollo frontend como en el backend. Siempre estoy abierto a nuevas oportunidades de crecimiento y colaboración. ¡Conectemos y creemos algo increíble juntos! 🌐💡
...
- 🎨 **Arte Digital**: Me encanta experimentar con colores y estilos, creando ilustraciones y concept art.  
- 🎮 **Pixel Art**: Disfruto diseñando sprites y personajes de estilo retro, especialmente para videojuegos.  
